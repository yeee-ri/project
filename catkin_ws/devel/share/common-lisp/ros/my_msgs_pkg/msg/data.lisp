...
(cl:defmethod cl:initialize-instance :after ((m <data>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'data)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_msgs_pkg-msg:<data> is deprecated: use my_msgs_pkg-msg:data instead.")))

(cl:ensure-generic-function 'first_name-val :lambda-list '(m))
(cl:defmethod first_name-val ((m <data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_msgs_pkg-msg:first_name-val is deprecated.  Use my_msgs_pkg-msg:first_name instead.")
  (first_name m))

(cl:ensure-generic-function 'last_name-val :lambda-list '(m))
(cl:defmethod last_name-val ((m <data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_msgs_pkg-msg:last_name-val is deprecated.  Use my_msgs_pkg-msg:last_name instead.")
  (last_name m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_msgs_pkg-msg:age-val is deprecated.  Use my_msgs_pkg-msg:age instead.")
  (age m))

(cl:ensure-generic-function 'score-val :lambda-list '(m))
(cl:defmethod score-val ((m <data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_msgs_pkg-msg:score-val is deprecated.  Use my_msgs_pkg-msg:score instead.")
  (score m))
